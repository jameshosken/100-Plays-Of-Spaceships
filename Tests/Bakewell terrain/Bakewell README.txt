...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Bakewell&box=-1.479938,53.296419,-1.855692,53.071841
...
-----------
  ...
  * Bakewell Height Map (ASTER 30m).png
  ...
  * Bakewell Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Bakewell Height Map (SRTM3 v4.1).png
  ...
  * Bakewell Height Map (SRTM30 Plus).png
