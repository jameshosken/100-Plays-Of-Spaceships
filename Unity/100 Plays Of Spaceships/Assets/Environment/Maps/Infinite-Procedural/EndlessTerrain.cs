...
public class EndlessTerrain : MonoBehaviour
{
    ...
    public class TerrainChunk {
        ...
        public TerrainChunk(Vector2 coord, int size, LODInfo[] _detailLevels, Transform parent, Material material)
        {
            ...
            meshObject.tag = "Shootable";
            meshObject.layer = LayerMask.NameToLayer("Shootable");
            ...
            mapGenerator.RequestMapData(OnMapDataReveived, position);
        }

        void OnMapDataReveived(MapData mapData)
        {
    ...
    class LODMesh{
        ...
        public LODMesh(int _lod, System.Action updateCallback)
        {
